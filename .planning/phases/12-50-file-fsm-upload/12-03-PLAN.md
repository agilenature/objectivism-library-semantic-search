...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    1. Review 12-03-SUMMARY.md for completeness -- all 7 data points present with verbatim output
    ...
    5. Note the T=0 timestamp -- T+4h check should happen ~4 hours later
  </how-to-verify>
